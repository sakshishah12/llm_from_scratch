...
class PostionalEmbeddings(nn.Module):
    def __init__(self,d_model:int,seq_len:int,dropout:float)->None:
        ...
        #create a matrix of size (seq_len,d_model). seq_len is maximum sentence length
...
def build_transformer(src_vocab_size:int,tgt_vocab_size:int,src_seq_len:int,tgt_seq_len:int,d_model:int=512,N:int=6,h:int=8,dropout:float=0.1,d_ff:int=2048)->None:
    ...
    src_pos=PostionalEmbeddings(d_model,src_seq_len,dropout)
    tgt_pos=PostionalEmbeddings(d_model,tgt_seq_len,dropout)
